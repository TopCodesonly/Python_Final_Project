...
def submit_data():
    ...
    if status == "Accepted":
        ...
        sql= f""" INSERT INTO DtaEntryForm(FNAME,LNAME,Title,AGE,Nationality,CC,SEM,RS) VALUES ('{first_name}','{last_name}','{title}','{age}','{nationality}','{num_courses}','{num_semesters}','{registration_status}')"""
